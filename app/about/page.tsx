  ...
  return (
    <main className="content-page prose-page">
      ...
      <p>
        ...
        Agentic Protocol file convention, free generator, auditor,
        documentation, and developer tools. <Link href="/">ruagentic.com</Link>{' '}
        is the directory for discovering projects and publishing listings.
      </p>
      <p>
      ...
      <p>
        ...
        a listing, or adopted the Agentic Protocol. Information submitted
        through an account is labeled separately.
      </p>
      ...
      <p>
        ...
        publication after your Agentic Protocol JSON, TXT, and README pass the
        file checker.
      </p>
